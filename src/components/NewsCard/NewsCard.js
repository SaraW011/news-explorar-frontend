  ...
  return (
    <>
      <li className="news-card">
        <button
          className="news-card__button news-card__button_type-bookmark"
          aria-label="bookmark card"
        ></button>

        <button
          className="news-card__button news-card__button_type-keyword"
        ...
        <div className="news-card__info">
          ...
          <h3 className="news-card__source">treehugger</h3>
        </div>
      </li>
      ...
      <li className="news-card">
        ...
        <div className="news-card__info">
          <div className="news-card__date">February 19, 2019</div>
          <h2 className="news-card__title">Nature makes you better</h2>
          <p className="news-card__paragraph">
          ...
          <h3 className="news-card__source">national geographic</h3>
        </div>
      </li>
      ...
      <li className="news-card">
        ...
        <div className="news-card__info">
          <div className="news-card__date">October 19, 2020</div>
          <h2 className="news-card__title">
      ...
      <li className="news-card">
        ...
        <div className="news-card__info">
          ...
          <h3 className="news-card__source">National parks traveler</h3>
        </div>
      </li>
      ...
      <li className="news-card">
        ...
        <div className="news-card__info">
          <div className="news-card__date">March 16, 2020</div>
          <h2 className="news-card__title">
